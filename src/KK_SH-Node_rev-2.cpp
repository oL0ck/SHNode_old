// Smart Home Node by OverLock
// Node just ask sensors and shows the result on the internal web page
// Also, internal Asyncweb allows API to get clear data from sensors simply
// All other data read in RTFM tab
// overlockg@gmail.com

// WARNING this code is out of date, it works only in arduino 
...
const char* ssid     = "PUTYOURSSSIDhere";                    // Ap name
const char* password = "wpasecurekey";   // Ap password
